...
# Copy documentation
cp "$REPO_ROOT"/OPENSSL_SECURE_SPEC.md "$PACKAGE_ROOT$INSTALL_PREFIX/share/doc/$PACKAGE_NAME/"
cp "$REPO_ROOT"/DSMIL_README.md "$PACKAGE_ROOT$INSTALL_PREFIX/share/doc/$PACKAGE_NAME/"
cp "$REPO_ROOT"/README-DSMIL.md "$PACKAGE_ROOT$INSTALL_PREFIX/share/doc/$PACKAGE_NAME/"
